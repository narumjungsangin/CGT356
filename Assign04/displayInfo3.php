...
<body>
    <h1 style= "fontsize: 14px; text-indent: 360px;"> Assign 04 - displayInfo3 Page</h1>
    <form id = "form0" name = "form0" action="storeInfo3.php" method = "post">
    <fieldset id = "proejct1">
            <legend>Project 1 Information</legend>
        <ul>
            <li><span><?php echo($_SESSION["id"]); ?></span></li>
            <li><span><?php echo($_SESSION["projectname"]); ?></span></li>
            <li><span><?php echo($_SESSION["description"]); ?></span></li>
            <li><span><?php echo($_SESSION["managername"]); ?></span></li>
            <li><span><?php echo($_SESSION["email"]); ?></span></li>
            <li><span><?php echo($_SESSION["phone"]); ?></span></li>
            <li><span><?php echo($_SESSION["department"]); ?></span></li>
        ...
        <ul>
            <li><span><?php echo($_SESSION["Cid"]); ?></span></li>
            <li><span><?php echo($_SESSION["Cprojectname"]); ?></span></li>
            <li><span><?php echo($_SESSION["Cdescription"]); ?></span></li>     
        </ul>
        </fieldset>
    </form>
<div id="nav"><span id="nav1"><a href="index3.php">Continue Updating</a></span><span id = "nav2"><a href="finishedUpdate.php">Finished Updating</a></span></div>
