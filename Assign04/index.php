...
<head>
    <meta charset="utf-8">
    <title>Assign 04 - index Page</title>
    <style type="text/css">
...
<body>
    <h1 style= "fontsize: 14px; text-indent: 360px;"> Assign04 - index Page</h1>

    <form id = "form0" name = "form0" action="storeInfo.php" method = "post">
        <fieldset id = "billing">
        ...
        <ul>
                <li> <label title = "SName" for = "Sname">Name <span>*</span></label> <input type="text" name="Sname" id="Sname" size="30" maxlength="30" value="<?php if(!empty($_SESSION["Sname"])){echo($_SESSION["Sname"]);} ?>"/></li>
                <li> <label title = "SAddress" for = "Saddress">Address <span>*</span></label> <input type="text" name="Saddress" id="Saddress" size="30" maxlength="30" value="<?php if(!empty($_SESSION["Saddress"])){echo($_SESSION["Saddress"]);} ?>"/></li>
                <li> <label title = "SCity" for = "Scity">City <span>*</span></label> <input type="text" name="Scity" id="Scity" size="30" maxlength="30" value="<?php if(!empty($_SESSION["Scity"])){echo($_SESSION["Scity"]);} ?>"/></li>
                <li> <label title = "SState" for = "Sstate">State <span>*</span></label> <input type="text" name="Sstate" id="Sstate" size="30" maxlength="30" value="<?php if(!empty($_SESSION["Sstate"])){echo($_SESSION["Sstate"]);} ?>"/></li>
                <li> <label title = "SZip" for = "Szip">Zip <span>*</span></label> <input type="text" name="Szip" id="Szip" size="7" maxlength="5" value="<?php if(!empty($_SESSION["Szip"])){echo($_SESSION["Szip"]);} ?>"/></li>
                <li> <label title = "SCountry" for = "Scountry">Country <span>*</span></label> <input type="text" name="Scountry" id="Scountry" size="30" maxlength="30" value="<?php if(!empty($_SESSION["Scountry"])){echo($_SESSION["Scountry"]);} ?>"/></li>
        </ul>
        </fieldset>
            <fieldset id="submit">
                <input id = "SubmitBtn" name = "SubmitBtn" type = "submit" value = "Proceed" />
                <p> This is index page. If you want to go to <a href= "index2.php">index2 page</a> or <a href= "index3.php">index3 page</a> press the following button.</p>
            </fieldset>
