...
<head>
    <meta charset = "utf-8"/>
    <title>Assign07 - Update Car</title>
    <style type = "text/css">
        ...
        span#radios{ color: #000000; font-weight:normal; padding:0px; margin-right: 130px;}
        input, select{float: right; margin-right: 10px; border: 1px solid #000; padding: 3px; width: 240px;}
        input[type="radio"]{float: none; margin-right: 0px; paddiong: 0px; width:40px;}
...
<body>
     <h1 style = "text-align: center;"> Assign07 - Update Car </h1>
    ...
    if($num_results == 0) $_SESSION["errorMessage"] = "You must first insert a Car ID with 23";
    ?>

     <form id="form0" name="form0" method="post" action="doUpdateCar.php">
        <fieldset>
            <legend>Update Assign06Cars table</legend>
            <ul>
                <li>
                    <label title="CarID" for = "CarID">CarID</label>

                    <input name = "CarIDdis" id="CarIDdis" type="text" size="20" maxlength="3" disabled="disabled"
                ...
                <li>
                    ...
                    <input name = "CarModel" id="CarModel" type="text" size="20" maxlength="20" 
                ...
                <li>
                    ...
                    <input name = "CarColor" id="CarColor" type="text" size="20" maxlength="20" 
                    value = <?php if($num_results != 0){echo(trim($row["CarColor"]));}  ?>>
                </li>

                <li>
                    <label title="CarHybrid" for = "CarHybrid">Car Hybrid?</label>
