...
<head>
    <meta charset = "utf-8"/>
    <title>Assign07 - Insert Car</title>
    <style type = "text/css">
        ...
        input[type="radio"]{float: none; margin-right: 0px; padding: 0px; width:40px;}
...
<body>
     <h1 style = "text-align: center;"> Assign07 - Insert Car </h1>
     <?php
     include("includes/menu.php");
     ?>

     <form id="form0" name="form0" method="post" action="doInsertCar.php">
        <fieldset>
            <legend>Insert into Assign06Cars table</legend>
            <ul>
                <li>
                    <label title="CarID" for = "CarID">Car ID</label>
                    <input name = "CarID" id="CarID" type="text" size="20" maxlength="3" />
                </li>
