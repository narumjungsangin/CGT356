...
<body>
    <h1 style= "fontsize: 14px; text-indent: 360px;"> Assign03 - getFormData Page</h1>

    <form id = "form0" name = "form0" action="displayFormData.php" method = "post">
        <fieldset id = "billing">
            ...
            <ul>
                ...
                <li> <label title = "Zip" for = "zip">Zip <span>*</span></label> <input type="text" name="zip" id="zip" size="7" maxlength="5" value="<?php echo($zip); ?>"/></li>
        ...
        <ul>
                ...
                <li> <label title = "SZip" for = "Szip">Zip <span>*</span></label> <input type="text" name="Szip" id="Szip" size="7" maxlength="5" value="<?php echo($Szip); ?>"/></li>
